    ...
    <>
      <div id="skills" style={{backgroundImage: `url(${bg})`}} className="wrapper h-full bg-no-repeat bg-center bg-cover p-16 lg:p-4">
        <div className="skills-wrapper text-center text-white bg-[#171717]  p-10 rounded-[50px] lg:p-2">
          ...
          Actively engaged in various projects where I applied ReactJS to create compelling and interactive user experiences. Whether it's designing responsive web interfaces or crafting cross-platform solutions, I'm adept at harnessing the power of these technologies to deliver dynamic and user-friendly applications.
          </p>
